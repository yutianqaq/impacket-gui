...
class InteractiveSession(QWidget):
    ...
    def init_ui(self):
        ...
        self.input_text.setPlaceholderText("Type your command and press Enter")
...
class ImpacketTerminal(QWidget):
    ...
    def init_ui(self):
        ...
        add_session_button = QTextEdit("Add Impacket Session")
        ...
        # 添加关闭当前会话按钮
        close_session_button = QPushButton("Close Current Session")
    ...
    def add_session_tab(self, event):
        ...
        if ip and username and password:
            ...
            # 在没有输入完整信息时显示错误消息
            QMessageBox.warning(self, "Error", "Please enter IP, Username, and Password.")
...
if __name__ == '__main__':
    ...
    tab_widget.addTab(impacket_executor, "Impacket GUI")
    tab_widget.addTab(impacket_terminal_tab, "Impacket Terminal")
    tab_widget.addTab(sam_the_admin_tab, "sam-the-admin")

    window = QWidget()
    window.setWindowTitle("Impacket App")
