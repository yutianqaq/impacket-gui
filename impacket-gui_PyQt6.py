...
import sys
from PyQt6.QtWidgets import QApplication, QLabel, QComboBox, QLineEdit, QPushButton, QDialog, QMessageBox, QTextEdit, QVBoxLayout, QWidget, QVBoxLayout, QTabWidget, QTextEdit, QPushButton, QHBoxLayout, QPlainTextEdit
from PyQt6.QtCore import QCoreApplication, Qt, QThread, pyqtSignal, QProcess, QTimer, QUrl
from PyQt6.QtGui import QIcon, QFont, QDesktopServices, QTextCursor,QTextOption
...
class InteractiveSession(QWidget):
    ...
    def connect_and_execute(self):
        ...
        self.session.setProcessChannelMode(QProcess.ProcessChannelMode.MergedChannels)
...
class ImpacketTerminal(QWidget):
    ...
    def init_ui(self):
        ...
        add_session_button.setAlignment(Qt.AlignmentFlag.AlignCenter)
